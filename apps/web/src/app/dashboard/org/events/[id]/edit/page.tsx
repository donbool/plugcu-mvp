...
export default function EditEventPage() {
    ...
    const fetchEvent = async () => {
      try {
        ...
        setFormData({
          ...
          application_deadline: eventData.application_deadline ? eventData.application_deadline.slice(0, 16) : '',
          expected_attendance: eventData.expected_attendance?.toString() || '',
          venue: eventData.venue || '',
          event_type: eventData.event_type || '',
          sponsorship_min_amount: eventData.sponsorship_min_amount?.toString() || '',
          sponsorship_max_amount: eventData.sponsorship_max_amount?.toString() || '',
          sponsorship_benefits: eventData.sponsorship_benefits || [],
          tags: eventData.tags || [],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/org/events/${event.id}`)
    } catch (error) {
    ...
    <DashboardLayout requiredRole="student_org">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Update your event details and sponsorship information</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Details about sponsorship opportunities and benefits</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Help brands discover your event</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
          ...
          <div className="flex justify-end gap-4">
            <Button
              type="button"
              variant="outline"
              onClick={() => router.push(`/dashboard/org/events/${event.id}`)}
            >
              Cancel
            </Button>
